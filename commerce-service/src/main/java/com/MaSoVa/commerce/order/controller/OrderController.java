...
public class OrderController {
    ...
    public ResponseEntity<Order> updateOrderItems(
        ...
        List<com.MaSoVa.commerce.order.entity.OrderItem> items =
            (List<com.MaSoVa.commerce.order.entity.OrderItem>) payload.get("items");
    ...
    public ResponseEntity<Order> addQualityCheckpoint(
            @PathVariable String orderId,
            @RequestBody com.MaSoVa.commerce.order.entity.QualityCheckpoint checkpoint) {
    ...
    public ResponseEntity<Order> updateQualityCheckpoint(
        ...
        com.MaSoVa.commerce.order.entity.QualityCheckpoint.CheckpointStatus status =
                com.MaSoVa.commerce.order.entity.QualityCheckpoint.CheckpointStatus.valueOf(payload.get("status"));
    ...
    public ResponseEntity<List<com.MaSoVa.commerce.order.entity.QualityCheckpoint>> getQualityCheckpoints(
            @PathVariable String orderId) {
        log.info("Fetching quality checkpoints for order: {}", orderId);
        List<com.MaSoVa.commerce.order.entity.QualityCheckpoint> checkpoints = orderService.getQualityCheckpoints(orderId);
    ...
    public ResponseEntity<com.MaSoVa.commerce.order.dto.PosStaffPerformanceDTO> getPosStaffPerformance(
        ...
        com.MaSoVa.commerce.order.dto.PosStaffPerformanceDTO performance = orderService.getPosStaffPerformance(
                staffId,
