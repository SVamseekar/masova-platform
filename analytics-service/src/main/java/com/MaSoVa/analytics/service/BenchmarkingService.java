...
public class BenchmarkingService {
    ...
    public BenchmarkingResponse generateBenchmarkingReport(String period) {
        ...
        BenchmarkingResponse.IndustryBenchmarks industryBenchmarks = new BenchmarkingResponse.IndustryBenchmarks();
        industryBenchmarks.setAverageAOV(BigDecimal.valueOf(350)); // ₹350 average order value
        industryBenchmarks.setAverageProfitMargin(BigDecimal.valueOf(15.5)); // 15.5%
        industryBenchmarks.setAverageCustomerRetention(BigDecimal.valueOf(68.0)); // 68%
        industryBenchmarks.setAverageDeliveryTime(BigDecimal.valueOf(35)); // 35 minutes
        industryBenchmarks.setDataSource("Industry Reports 2025");
        industryBenchmarks.setIndustrySegment("Quick Service Restaurant");
