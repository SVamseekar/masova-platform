...
const PROMOTIONS = [
  ...
  },
  {
    id: 3,
    title: 'Free Delivery',
    description: 'Zero delivery charges on any order above €50',
    originalPrice: null,
    dealPrice: 'Free',
    discount: '€0 Delivery',
  ...
  },
  {
    id: 5,
    title: 'Power Lunch',
    description: 'Main + Bread + Drink — a complete meal for €29.90',
    originalPrice: '€49.90',
    dealPrice: '€29.90',
    discount: '40% OFF',
  ...
  },
  {
    ...
    description: 'New here? Get €15 off your very first order above €50',
    originalPrice: null,
    dealPrice: '€15 OFF',
    discount: '€15 OFF',
