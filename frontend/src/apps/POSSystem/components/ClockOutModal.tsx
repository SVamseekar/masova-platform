...
const ClockOutModal: React.FC<ClockOutModalProps> = ({ isOpen, onClose, storeId }) => {
  ...
  const handleClockOut = async () => {
    ...
    if (!confirm(`Are you sure you want to clock out ${session.employeeName}?`)) {
      return;
    }
