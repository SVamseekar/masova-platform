...
describe('StoreInfo', () => {
  it('shows loading state', () => {
    ...
    renderWithProviders(<StoreInfo storeId="store-1" />);
  ...
  it('returns null when no store data and not loading', () => {
    ...
    const { container } = renderWithProviders(<StoreInfo storeId="store-1" />);
  ...
  it('renders detailed variant with extra information', () => {
    ...
    renderWithProviders(<StoreInfo storeId="store-1" variant="detailed" />);
    expect(screen.getByText('Downtown Branch')).toBeInTheDocument();
  ...
  it('skips query when storeId is empty', () => {
    ...
    renderWithProviders(<StoreInfo storeId="" />);
