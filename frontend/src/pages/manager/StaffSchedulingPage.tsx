  ...
  return (
    <>
      ...
      <AppHeader
        ...
        onBack={handleBack}
        showManagerNav={true}
        storeSelectorContextKey="staff-scheduling"
      />
            ...
            <Card style={styles.dialog} onClick={(e) => e.stopPropagation()}>
              ...
              <div style={styles.formGroup}>
                <label style={styles.checkboxLabel}>
                  ...
                  />
                  <span style={{ marginLeft: spacing[3] }}>Mandatory Shift</span>
                </label>
              </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  shiftCell: {
    ...createNeumorphicSurface('flat', 'base', 'sm'),
    padding: spacing[3],
    minHeight: '80px',
    display: 'flex',
    flexDirection: 'column',
  ...
  input: {
    ...createNeumorphicSurface('inset', 'base', 'sm'),
    width: '100%',
    padding: spacing[4],
