...
export interface Store {
  ...
  createdAt?: string;
  lastModified?: string;
  countryCode?: string;  // ISO 3166-1 alpha-2, e.g. "DE". Null = India legacy
  currency?: string;     // ISO 4217, e.g. "EUR". Null = India legacy (INR)
  locale?: string;       // BCP 47, e.g. "de-DE". Null = India legacy (en-IN)
  vatNumber?: string;
}
