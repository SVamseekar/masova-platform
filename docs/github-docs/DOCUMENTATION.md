...
```
**Use dropdown to switch between all 6 services!**

### Individual Services
```
Core:         http://localhost:8085/swagger-ui.html
Commerce:     http://localhost:8084/swagger-ui.html
Payment:      http://localhost:8089/swagger-ui.html
Logistics:    http://localhost:8086/swagger-ui.html
Intelligence: http://localhost:8087/swagger-ui.html
```
